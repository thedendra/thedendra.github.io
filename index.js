function homepage()
{
    if(window.location.href !== "https://thedendra.github.io")
    {
...
function products()
{
    const bts = document.getElementsByClassName("buynowli");

    for(var i = 0; i < bts.length; i++)
    {
        bts[i].setAttribute("onclick", "window.location.href = '/discprs/'");
    }
}
